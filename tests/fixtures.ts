...
export const TestFixtures = {
  /**
   * Basic mind map with minimal structure
   */
  ...
  /**
   * Complex mind map with deep nesting
   */
  ...
  /**
   * Sample node for testing node processing
   */
  ...
  /**
   * Generate raw JSON response like OpenAI would return
   */
